...
public interface CalculationService {
    Flux<OrderedCalculation> calculateOrdered(String firstFunction, String secondFunction, int count);
    Flux<UnorderedCalculation> calculateUnordered(String firstFunction, String secondFunction, int count);
}
